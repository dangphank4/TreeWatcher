...
import 'package:flutter_api/core/constants/app_evironment.dart';
...
import 'package:flutter_api/core/network/dio_client.dart';
...
final class Utils {
  ...
  static void openEmail(String email) async {
    final Uri emailUri = Uri(
      ...
      query: encodeQueryParameters({
        'subject':
        "[Flutter Project for ${Platform.isIOS ? 'iOS' : 'Android'}] Feedback of version ${GeneralHelper.appVersion}",
        'body':
  ...
  static String formatCallDuration(BuildContext context, int duration) {
    if (duration < 60) {
      return '$duration ${context.localization.sec}';
    } else if (duration < 3600) {
      final mins = duration ~/ 60;
      final sec = duration % 60;
      return '$mins ${context.localization.mins} $sec ${context.localization.sec}';
    } else {
      final hours = duration ~/ 3600;
      final remainingSeconds = duration % 3600;
      final mins = remainingSeconds ~/ 60;
      final sec = remainingSeconds % 60;
      return '$hours ${context.localization.hours} $mins ${context.localization.mins} $sec ${context.localization.sec}';
    }
  }
  ...
  static bool isEmoji(String message) {
